...
contract SousChef {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = biot.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 biotSupply = biot.balanceOf(address(this));
        if (biotSupply == 0) {
        ...
        poolInfo.accRewardPerShare = poolInfo.accRewardPerShare.add(tokenReward.mul(1e12).div(biotSupply));
        poolInfo.lastRewardBlock = block.number;
    }
    ...
    function deposit(uint256 _amount) public {
        ...
        updatePool();
        biot.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        updatePool();
        biot.safeTransfer(address(msg.sender), _amount);
    ...
    function emergencyWithdraw() public {
        UserInfo storage user = userInfo[msg.sender];
        biot.safeTransfer(address(msg.sender), user.amount);
