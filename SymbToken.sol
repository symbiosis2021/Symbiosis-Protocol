...
contract Ownable is Context {
 ...
 contract SymbiosisProtocol is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Symbiosis Protocol';
    string  private constant _SYMBOL = 'SYMB';
